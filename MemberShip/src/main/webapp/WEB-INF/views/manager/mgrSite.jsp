...
<script type="text/javascript">
	//단일 체크 
	function siteCheck(chk){
		var obj = document.getElementsByName("siteCheck");
		...
		<table class="mSiteTable">
			...
			<c:forEach var="siteList" items="${siteList}">
				<tr class="mSiteTable-row">
					<td>
						<input type="checkbox" class="siteCheck" name="siteCheck" id="siteCheck" onclick="siteCheck(this)">
